...
# Gender distribution
ggplot(df, aes(x=Gender)) + geom_bar(fill="orange") +
...
df$age_group <- cut(df$age, breaks=c(0, 18, 25, 35, 45, 55, 65, 100),
...
# Plottting a stacked barplot for representing purchase categories across different age groups
...
# Plottting a stacked barplot for representing purchase categories across different genders
